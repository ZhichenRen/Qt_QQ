...
//    ui->userTableWidget->setContextMenuPolicy(Qt::ActionsContextMenu);
//    QAction *action = new QAction(tr("&Show message"), ui->userTableWidget);
//    connect(action, SIGNAL(triggered(bool)), this, SLOT(showMessage("haha")));
//    ui->userTableWidget->addAction(action);
